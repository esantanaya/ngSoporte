...
<div id="form_container">
	...
	<table cellspacing="0" cellpadding="0" border="0" class="ticket_form">
		<tbody>
			...
			<tr>
				<td class="table_title"><label for="cambia_pass">Forzar cambio de contrase&ntilde;a:</label></td>
				<td class="centrado">
					<input type="checkbox" class="check" name="cambia_pass" id="cambia_pass" value="Requerir cambio de contrase&ntilde;a" checked><label>&nbsp;</label>
				</td>
			</tr>
			<tr>
