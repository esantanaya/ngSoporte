...
<body>
	<div id="wrapper">
		...
		<div id="content">
			<div id="titulo">
				<h1><span class="rojo">>></span><?=$heading;?></h1>
			</div>
			<div class="linea"></div>
			<div id="error">
				<div id="logoError"></div>
				<div id="texto">
					<h3><span class="rojo">+ Ooops tuvimos un error</span></h3>
					<p>Parece ser que tuvimos un problema al procesar tus datos, contacta al administrador del sistema <a href="/">INICIO</a></p>
				</div>
			</div>
		</div>
	</div>
