...
class Cuenta extends CI_Controller {
	...
	public function preferencias()
	{
		...
		$uno = ($comida->des_horario == 'Matutino') ? 'checked' : '';
		$dos = ($comida->des_horario == 'Vespertino') ? 'checked' : '';
		$no = ($comida->des_horario == 'Corrido') ? 'checked' : '';
	...
	public function guarda_preferencias()
	{
		...
		$cod_usuario = $this->session->userdata('nombreUsuario');
		$data = array('id_horario' => $salida);
		$id_usuario = $this->usuario_model->get_id_usuario($cod_usuario);
		$this->usuario_model->update_usuario_horario($id_usuario, $data);
		$this->preferencias();
	}
